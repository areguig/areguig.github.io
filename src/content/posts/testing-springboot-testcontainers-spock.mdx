...
description: "An elegant way to implement tests for Spring-Boot applications using TestContainers and Spock framework."
date: "2017-03-31"
tags: ["Spring Boot", "Testing", "TestContainers", "Spock", "Java"]
published: true
---
